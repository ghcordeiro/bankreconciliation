...
class CsvAccountingTransactionFileParserTest {

    private CsvAccountingTransactionFileParser parser;

    @BeforeEach
    void setUp() {
        parser = new CsvAccountingTransactionFileParser();
    }
    ...
    void shouldParseCsvFileCorrectly() {
        ...
        StepVerifier.create(parser.parse(filePart))
                .assertNext(transactions -> {
                    ...
                    AccountingTransaction t1 = transactions.get(0);
                    ...
                    AccountingTransaction t2 = transactions.get(1);
