...
class BankTransactionServiceTest {
    ...
    private TransactionFileParser<BankTransaction> parser;
    ...
    void setup() {
        ...
        service = new BankTransactionService(parser, repository);
    }
    ...
    void shouldProcessFileAndSaveTransactions() {
        ...
        List<BankTransaction> transactions = List.of(
                BankTransaction.builder().description("Transação A").build(),
                BankTransaction.builder().description("Transação B").build()
        );
    ...
    void shouldFilterTransactionsByDescription() {
        var tx1 = BankTransaction.builder()
                .description("Salário")
        ...
        var tx2 = BankTransaction.builder()
                .description("Mercado")
        ...
        Mono<List<BankTransaction>> result = service.findByFilter(filter);
